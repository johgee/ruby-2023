...
# person = { "first_name" => "ada", "last_name" => "love", "email" => "adalove@gmail.com" }
# p person["first_name"]
# p person["last_name"]
# p person["email"]
...
# book = { "title" => "the art of game", "author" => "jesse", "pages" => 520, "language" => "english" }
# p book["title"]
# p book["author"]
# p book["pages"]
# p book["language"]
...
# books = [
#   { "title" => "reality is broken", "author" => "jane" },
#   { "title" => "code", "author" => "charles" },
#   { "title" => "the humane interface", "author" => "jef" },
# ]
# p books[2]["author"]

# 6. Make a hash to store 3 different states and their captitals. Then add a new state and capital and print the hash to see the result.
# capitals = { "california" => "sacremento", "illinois" => "springfield", "new york" => "albany" }
# capitals["tennesse"] = "nashville"
# p capitals
...
# dictionary["happy"] = "when you're smiling"
# p dictionary
